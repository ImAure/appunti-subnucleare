...
\usepackage{tensor}                 % =======================================
\usepackage[version = 4]{mhchem}    % per le formule chimiche
\usepackage{siunitx}
...
\usepackage{pgf}
\usepackage{pgfplots}               % per fare i grafici
\usepackage{enumitem}               % per le liste numerate e puntate 
\usepackage{listings}
